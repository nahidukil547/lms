...
urlpatterns = [
    ...
    path('submission/list/', SubmissionListCreateView.as_view(), name='course_list'),
    path('submission/update/<int:pk>/', SubmissionUpdateDeleteView.as_view(), name='course_details'),
] 